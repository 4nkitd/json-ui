export class UiManager {
    ...
    renderElement(key) {
      ...
      const inputAttributes = {
        ...
        class: "Ui-json checkbox checkbox-success",
      };
    ...
    renderSubElements(rootElement, subElements) {
      ...
      return Object.keys(subElements)
        .map((elm) => {
          ...
          inputAttributes.checked = this.selectedKeys.has(`${rootElement}-${elm}`)
            ? "checked"
            : "";
          return this.tag(
            "div",
    ...
    addEventListeners() {
      ...
      const collapseTitles = this.rootElement.querySelectorAll(".collapse-title");
